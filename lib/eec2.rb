...
require 'eec2/start_command.rb'
require 'eec2/stop_command.rb'
require 'eec2/ssh_command.rb'
require 'eec2/scp_command.rb'
require 'eec2/ren_command.rb'
require 'eec2/create_command.rb'
require 'eec2/delete_command.rb'
